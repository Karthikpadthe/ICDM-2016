...
fit <- ncTL(centered_x[-folds[[i]],],centered_y[-folds[[i]]],tp=graph,s1=lambda[j],s2=lambda[k],RaMaxIter=2000,Rtau=0.5,RmaxIter=200)# here we fit the model on train data
